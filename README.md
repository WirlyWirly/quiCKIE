...
Only the **quiURL** and **ApiKey** are required, everything else is optional. Hover over the various emojis for more info about what each field does and how it can be filled in. The quiCKIE settings panel can be accessed by performing a **Shift-Click** on any BunnyButton, or from the menu of your UserScript Manager, which is the dialogue on your toolbar that lists the currently active UserScripts. 
...
> **Ctrl-Click**: Open qui in a new tab<br>
> **Shift-Ctrl-Click**: Send torrent to qui, but paused (works for both the current tracker settings and presets)<br>
>
