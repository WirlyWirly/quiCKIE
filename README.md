...
This UserScript will generate **BunnyButtons 🐰** alongside a sites regular download buttons. When clicked, the corresponding torrent will be sent to [qui](https://getqui.com/) using your custom settings.
...
The quiCKIE settings panel is registered to the menu of your UserScript Manager, which is the dialogue on your toolbar that lists the currently active UserScripts. Only the **quiURL** and **ApiKey** are required, every other setting is optional. Hover over the various emojis for more info about what each field does and how it can be filled in.
